export const connectionError = "Connection error! Please try again later.";

export const existingAccount =
  "Account with the email already in existence, please use another email or login with your details.";

export const accountCreated = "Account successfully created.";
...
export const account_not_found = "Account with email not found, try again.";

export const incorrectCredentials =
  "The login details not correct, kindly try again.";
